...
if HAS_SQLITE3 || HAS_MYSQL || HAS_POSTGRES
  describe 'DataMapper' do
    describe "#auto_migrate!" do
      ...
      it "should get called on a uuidified inner class" do
  ...
  describe 'DataMapper::Is::Uuidified' do
    ...
    describe "#create" do
      ...
      it "should not create a uuidified copy" do
    ...
    describe "#save" do
      ...
      describe "(with a dirty existing resource)" do
        ...
        it "should create a uuidified copy" do
          Story::Version.all.size.should == 1
        end

        it "should not have the same value for the uuidified field" do
