module DataMapper
  module Is
    ...
    #
    # The is-uuidified plugin functions differently from other versioning
    # solutions (such as acts_as_uuidified), but can be configured to
    ...
    # automatically update your :updated_at field. See uuidified_spec for
    # and example of updating the uuidified field yourself.
    #
    #   class Story
